...
pdfLogo:{fontSize:24,fontWeight:"900",marginTop:4,letterSpacing:-1,position:"relative",display:"inline-block",paddingTop:4},
pdfLogoHorn:{position:"absolute",left:60,top:-3,width:28,height:8,background:"#b08d4f",transform:"skewX(-28deg) rotate(-12deg)",borderRadius:"8px 2px 8px 2px",display:"block"},
