...
function PDFView({refx,form,totals}){
  ...
  return <div ref={refx} style={styles.pdfNew}>
    ...
    <div style={styles.pdfHeaderBar}>
      ...
      <div style={styles.pdfLogo}><span style={styles.pdfLogoHorn}></span><span style={{color:"#174a8b"}}>Agung</span><span style={{color:"#d71920"}}>TOYOTA</span></div>
    </div>
...
pdfInfo:{margin:"2px 0",fontSize:8.5,fontWeight:"800",textAlign:"left"},
pdfLogo:{fontSize:24,fontWeight:"900",marginTop:4,letterSpacing:-1,position:"relative",display:"inline-block",paddingTop:8},
pdfLogoHorn:{position:"absolute",left:69,top:-2,width:44,height:14,background:"linear-gradient(135deg,#8b6a2d 0%,#b49350 45%,#d2b36a 100%)",clipPath:"polygon(0 78%, 78% 0, 100% 0, 34% 100%)",transform:"rotate(-18deg)",transformOrigin:"left center",display:"block"},
