...
function MasterPart({partDb,setPartDb}){
  ...
  return <section style={styles.card}><h1>Master Sparepart</h1>
    ...
    <button style={styles.red} onClick={()=>{ if(confirm("Hapus semua sparepart?")) setPartDb([]); }}>Delete All Sparepart</button>
...
function MasterCustomer({customerDb,setCustomerDb}){
  ...
  return <section style={styles.card}><h1>Master Customer</h1>
    ...
    <button style={styles.red} onClick={()=>{ if(confirm("Hapus semua customer?")) setCustomerDb([]); }}>Delete All Customer</button>
