    ...
    setForm((p) => ({
      ...
      [type]: p[type].map((r) => {
        ...
        if (type === "parts" && key === "partNo") {
          const found = findBestPart(partDb, "partNo", value);
          if (found) {
...
pdfBranch:{fontSize:26,margin:"0 0 5px",fontWeight:"900",letterSpacing:.1,textAlign:"left"},
pdfInfo:{margin:"3px 0",fontSize:10,fontWeight:"700",textAlign:"left"},
pdfLogo:{fontSize:28,fontWeight:"900",marginTop:4,letterSpacing:-1},
